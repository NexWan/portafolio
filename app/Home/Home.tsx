...
const Home = () => {
  ...
  return (
    <div id='homeBody' className={`${styles.homeBody} ${styles.fadeIn} ${' z-10 text-2xl rounded-b-xl py-5 min-h-screen text-center justify-center content-center my-auto '}`}>
      <div className='p-5'>
        <ReactTyped
          onBegin={() => { typed?.stop(); }}
