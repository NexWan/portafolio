...
const Header = () => {
  ...
  return (
    <div className={` overscroll-contain w-screen mx-auto border-b-2 border-b-white sticky  top-0 transition-all ${isSticky ? 'bg-dark-nav scale-y-105' : 'bg-transparent'} overflow-x-hidden`}>
